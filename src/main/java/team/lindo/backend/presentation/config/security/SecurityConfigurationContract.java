...
public abstract class SecurityConfigurationContract {
    ...
    private CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("https://lindo.co.kr", "http://localhost:3000",
                "https://lindo-frontend-git-branch6-noopys-projects-35d4e576.vercel.app", "https://lindohub.com", "https://www.lindohub.com")); // origin 설정
